...
Future<Album> fetchCateg() async {
  final response = await http.get(Uri.parse(
      'https://us-central1-takweed-eg.cloudfunctions.net/client/topics'));
...
*/
  ...
  Widget build(BuildContext context) {
    ...
    //= ['Health', 'Politics', 'Art', 'Food', 'Science']
...
class _NewsList extends StatelessWidget {
  ...
  return http.get(Uri.parse(
    ...
    Response response = await http.get(Uri.parse(
        "https://us-central1-takweed-eg.cloudfunctions.net/client/posts"))
    return Album.fromJson(json.decode(reponse));
  }
   */
